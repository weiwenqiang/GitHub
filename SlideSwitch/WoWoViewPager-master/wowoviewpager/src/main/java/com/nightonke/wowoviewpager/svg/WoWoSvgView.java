...
public class WoWoSvgView extends View implements WoWoAnimationInterface {
    ...
    public WoWoSvgView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public WoWoSvgView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.WoWoSvgView);
            mViewportWidth = a.getDimension(R.styleable.WoWoSvgView_wowo_imageSizeX, getResources().getDimension(R.dimen.default_svgImageSizeX));
            aspectRatioWidth = a.getDimension(R.styleable.WoWoSvgView_wowo_imageSizeX, getResources().getDimension(R.dimen.default_svgImageSizeX));
            mViewportHeight = a.getDimension(R.styleable.WoWoSvgView_wowo_imageSizeY, getResources().getDimension(R.dimen.default_svgImageSizeY));
            aspectRatioHeight = a.getDimension(R.styleable.WoWoSvgView_wowo_imageSizeY, getResources().getDimension(R.dimen.default_svgImageSizeY));
            mTraceTime = a.getInt(R.styleable.WoWoSvgView_wowo_traceTime, getResources().getInteger(R.integer.default_svgTraceTime));
            mTraceTimePerGlyph = a.getInt(R.styleable.WoWoSvgView_wowo_traceTimePerGlyph, getResources().getInteger(R.integer.default_svgTraceTimePerGlyph));
            mFillStart = a.getInt(R.styleable.WoWoSvgView_wowo_fillStart, getResources().getInteger(R.integer.default_svgFillStartTime));
            mFillTime = a.getInt(R.styleable.WoWoSvgView_wowo_fillTime, getResources().getInteger(R.integer.default_svgFillTime));
            mMarkerLength = a.getDimension(R.styleable.WoWoSvgView_wowo_traceMarkerLength, getResources().getDimension(R.dimen.default_svgTraceMarkerLength));
            int glyphStringsId = a.getResourceId(R.styleable.WoWoSvgView_wowo_glyphStrings, getResources().getInteger(R.integer.default_svgGlyphStrings));
            int traceResidueColorsId = a.getResourceId(R.styleable.WoWoSvgView_wowo_traceResidueColors, getResources().getInteger(R.integer.default_svgTraceResidueColors));
            int traceColorsId = a.getResourceId(R.styleable.WoWoSvgView_wowo_traceColors, getResources().getInteger(R.integer.default_svgTraceColors));
            int fillColorsId = a.getResourceId(R.styleable.WoWoSvgView_wowo_fillColors, getResources().getInteger(R.integer.default_svgFillColors));
